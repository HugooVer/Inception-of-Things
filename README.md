...
#### Other way is to use a ssh tunnel port forwarding (On Physical Host)

#### Add this to ```~/.ssh/config```
```
Host 192.168.123.46
	LocalForward 4242 192.168.56.110:80
```
#### Add this to ```/etc/hosts``` for easy acces to pods
```
127.0.0.1	app1.com app2.com app3.com random.com
```